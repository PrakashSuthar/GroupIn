...
public class Upload_ItemsActivity extends AppCompatActivity {
    class Teacher{
    ...
    */
    public class ListViewAdapter extends BaseAdapter {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            {
                Picasso.with(c).load(teacher.getImageURL()).placeholder(R.drawable.placeholder).into(teacherImageView);
                ...
                Picasso.with(c).load(R.drawable.placeholder).into(teacherImageView);
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.upload_activity_items);
        ...
        new DataRetriever(Upload_ItemsActivity.this).retrieve(myGridView,myDataLoaderProgressBar);
    }
}